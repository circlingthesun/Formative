...
var draw = function(context, boxColor, arrowColor) {
    ...
    // Draw text
    if(context === ctx && (this.type === 'LABEL' || this.type === 'TEXT')){
...
var testdata = {
    "6": {
        "val": "SIGNATURE OF PARENT af under 18) .", 
        "h": 3, 
        "w": 226, 
        "y": 1616, 
        "x": 960, 
    ...
    "237": {
        "val": "Online Entries Q www.enteronline.co.za", 
        "h": 43, 
        "len": 7, 
        "w": 266, 
        "y": 229, 
